	...
	function doCall($url = null, $requireAuth = false,$params = null){
		try{
			...
			//{
				...
				//SS_Log::log( New Exception('doCall - requireAuth'), SS_Log::NOTICE );
			//}
			//else
				//SS_Log::log( New Exception('doCall - no requireAuth'), SS_Log::NOTICE );
...
//SS_Log::log( New Exception('xml=' . $xml), SS_Log::NOTICE );
//SS_Log::log( New Exception('params=' . $twitter->queryString), SS_Log::NOTICE );
