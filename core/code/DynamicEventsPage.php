...
class DynamicEventsPage extends Page {
...
class DynamicEventsPage_Controller extends Page_Controller {
    function init() {
	parent::init();
	/* 
...
<% require javascript(themes/millroadwinterfair/js/dynamic_events_page.js) %>*/
	...
	");
	Requirements::javascript("themes/millroadwinterfair/js/dynamic_events_page.js");
    }
}
