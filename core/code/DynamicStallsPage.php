...
class DynamicStallsPage extends Page {
...
class DynamicStallsPage_Controller extends Page_Controller {
    function init() {
	parent::init();
/* 
...
<% require javascript(themes/millroadwinterfair/js/dynamic_stalls_page.js) %>*/
	...
	");
	Requirements::javascript("themes/millroadwinterfair/js/dynamic_stalls_page.js");
    }	
}
